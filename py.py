        ...
        if not m:
            if self.txt1.text == "" or self.txt2.text == "" or self.txt3.text == "" or self.spinner.text == "CHOOSE" or self.txt4.text == "" or self.txt5.text == "":
                if self.txt1.text == "":
                    ...
                    self.label1.text = "please provide a link"
                elif self.txt4.text == "":
                ...
                time.sleep(3)
                try:
                    page.find_element_by_class_name("yWX7d").click()
                except Exception as e:
                    pass
                time.sleep(2)
                if self.spinner.text == "Visualize":
                    try:
                        ...
                        self.label1.text = "please provide correct password and login"
                        key = False
                if key:
                    try:
                        page.get(f"{self.txt3.text}")
                        counter = 1
                        time.sleep(1)
                        ...
                        self.label1.text = "please provide correct link"
        self.follow()
